//
//  TableViewController Libros Leidos.swift
//  Bookmarik
//
...
class TableViewController_Libros_Leidos: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return arregloLeidos.count
    }
    
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celdita", for: indexPath) as! TableViewCellTitulo
        let celdaReciclada=arregloLeidos[indexPath.row]
